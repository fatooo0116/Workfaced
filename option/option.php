...
function register_mysettings2() {
  ...
  //  register_setting( 'ruibian-settings-group', 'ddg_option_blog' );
    ...
    register_setting( 'ruibian-settings-group', 'press_archive_header');
    register_setting( 'ruibian-settings-group', 'press_archive_header_mobile');
                    ...
                    <ul>
                        <li>
                            <form method="post" action="options.php"  style="padding: 0 20px;">
                                ...
                                <table class="form-table">
                                    <tr valign="top"  class="uploader" >
                                        <th scope="row">Press  Header Image</th>
                                        <td>
                                            <input id="_unique_name5" class="form-control" name="press_archive_header" type="text" value="<?php echo esc_attr( get_option('press_archive_header') ); ?>"/><br/>
                                ...
                                <table class="form-table">
                                    <tr valign="top"  class="uploader" >
                                        <th scope="row">Press  Mobile Header Image</th>
                                        <td>
                                            <input id="_unique_name6" class="form-control" name="press_archive_header_mobile" type="text" value="<?php echo esc_attr( get_option('press_archive_header_mobile') ); ?>"/><br/>
                                            <input id="_unique_name6_button" class="button _unique_name_button" name="_unique_name_button" type="text" value="Upload" />
                                        </td>
                                    </tr>
                                </table> 
